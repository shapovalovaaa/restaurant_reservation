...
var Ut = function(t2) {
  var r2 = t2.icon, n = t2.className, o = "react-datepicker__calendar-icon";
  return import_react2.default.isValidElement(r2) ? import_react2.default.cloneElement(r2, { className: "".concat(r2.props.className || "", " ").concat(o, " ").concat(n) }) : "string" == typeof r2 ? import_react2.default.createElement("i", { className: "".concat(o, " ").concat(r2, " ").concat(n), "aria-hidden": "true" }) : import_react2.default.createElement("svg", { className: "".concat(o, " ").concat(n), xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512" }, import_react2.default.createElement("path", { d: "M96 32V64H48C21.5 64 0 85.5 0 112v48H448V112c0-26.5-21.5-48-48-48H352V32c0-17.7-14.3-32-32-32s-32 14.3-32 32V64H160V32c0-17.7-14.3-32-32-32S96 14.3 96 32zM448 192H0V464c0 26.5 21.5 48 48 48H400c26.5 0 48-21.5 48-48V192z" }));
};
Ut.defaultProps = { className: "" };
var zt = Ut;
var $t = function(t2) {
  De(n, import_react2.default.Component);
  var r2 = be(n);
...
var Jt = function(t2) {
  ...
  function n(t3) {
    ...
    return he(this, n), ye(ke(o = r2.call(this, t3)), "getTabChildren", function() {
      return Array.prototype.slice.call(o.tabLoopRef.current.querySelectorAll("[tabindex], a, button, input, select, textarea"), 1, -1).filter(Gt);
  ...
  return fe(o, [{ key: "render", value: function() {
    ...
    if (!s) {
      ...
      t3 = import_react2.default.createElement(Popper, ve({ modifiers: p, placement: c }, l), function(t4) {
        ...
        return import_react2.default.createElement(Jt, { enableTabLoop: u }, import_react2.default.createElement("div", { ref: r2, style: n3, className: y, "data-placement": o3, onKeyDown: h }, import_react2.default.cloneElement(i, { arrowProps: a2 })));
      });
    }
    this.props.popperContainer && (t3 = import_react2.default.createElement(this.props.popperContainer, {}, t3)), m && !s && (t3 = import_react2.default.createElement($t, { portalId: m, portalHost: f }, t3));
...
var Zt = "react-datepicker-ignore-onclickoutside";
var er = react_onclickoutside_es_default(qt);
var tr = "Date input not valid.";
var rr = function(t2) {
  ...
  function s(t3) {
    ...
    return he(this, s), ye(ke(i = a.call(this, t3)), "getPreSelection", function() {
      ...
      i.setState({ open: e2, preSelection: e2 && i.state.open ? i.state.preSelection : i.calcInitialState().preSelection, lastPreSelectChange: or }, function() {
      ...
      if (!i.props.onChangeRaw || (i.props.onChangeRaw.apply(ke(i), t4), "function" == typeof n.isDefaultPrevented && !n.isDefaultPrevented())) {
        i.setState({ inputValue: n.target.value, lastPreSelectChange: nr });
      ...
      if (i.state.open || i.props.inline || i.props.preventOpenOnFocus) {
        if (i.state.open) {
          ...
          "Enter" === t4 ? (e2.preventDefault(), i.inputOk() && i.state.lastPreSelectChange === or ? (i.handleSelect(n, e2), !i.props.shouldCloseOnSelect && i.setPreSelection(n)) : i.setOpen(false)) : "Escape" === t4 ? (e2.preventDefault(), i.sendFocusBackToInput(), i.setOpen(false)) : "Tab" === t4 && i.setOpen(false), i.inputOk() || i.props.onInputError({ code: 1, msg: tr });
        }
      } else
      ...
      if ("Enter" === t4)
        ...
        e2.preventDefault(), i.setOpen(false), i.inputOk() || i.props.onInputError({ code: 1, msg: tr });
        ...
        if (!n)
          return void (i.props.onInputError && i.props.onInputError({ code: 1, msg: tr }));
        if (e2.preventDefault(), i.setState({ lastPreSelectChange: or }), i.props.adjustDateOnChange && i.setSelected(n), i.setPreSelection(n), i.props.inline) {
      ...
      var t4, n = (0, import_classnames.default)(i.props.className, ye({}, Zt, i.state.open)), o = i.props.customInput || import_react2.default.createElement("input", { type: "text" }), a2 = i.props.customInputRef || "ref", s2 = "string" == typeof i.props.value ? i.props.value : "string" == typeof i.state.inputValue ? i.state.inputValue : i.props.selectsRange ? function(e2, t5, r2) {
        if (!e2)
          return "";
  ...
  return fe(s, [{ key: "componentDidMount", value: function() {
    ...
    return import_react2.default.createElement("div", { className: "react-datepicker__input-container".concat(r2 ? " react-datepicker__view-calendar-icon" : "") }, r2 && import_react2.default.createElement(zt, { icon: n, className: o }), this.state.isRenderAriaLiveMessage && this.renderAriaLiveRegion(), this.renderDateInput(), this.renderClearButton());
  } }, { key: "render", value: function() {
    var t3 = this.renderCalendar();
    if (this.props.inline)
      return t3;
    if (this.props.withPortal) {
      var r2 = this.state.open ? import_react2.default.createElement(Jt, { enableTabLoop: this.props.enableTabLoop }, import_react2.default.createElement("div", { className: "react-datepicker__portal", tabIndex: -1, onKeyDown: this.onPortalKeyDown }, t3)) : null;
      return this.state.open && this.props.portalId && (r2 = import_react2.default.createElement($t, { portalId: this.props.portalId, portalHost: this.props.portalHost }, r2)), import_react2.default.createElement("div", null, this.renderInputContainer(), r2);
    }
    return import_react2.default.createElement(Xt, { className: this.props.popperClassName, wrapperClassName: this.props.wrapperClassName, hidePopper: !this.isCalendarOpen(), portalId: this.props.portalId, portalHost: this.props.portalHost, popperModifiers: this.props.popperModifiers, targetComponent: this.renderInputContainer(), popperContainer: this.props.popperContainer, popperComponent: t3, popperPlacement: this.props.popperPlacement, popperProps: this.props.popperProps, popperOnKeyDown: this.onPopperKeyDown, enableTabLoop: this.props.enableTabLoop });
  } }], [{ key: "defaultProps", get: function() {
